...
const dictionaries: Record<LanguageCode, Dict> = {
  ...
  hi: {
    ...
    "common.selectLanguage": "भा���ा चुनें",
    ...
    "farm.namePh": "उदा., ग्रीन व��ली फार्म",
    ...
    "vet.searchPlaceholder": "फार्म आईडी या किसान नाम से खोजें",
    "vet.allRisks": "सभी जोखिम",
    "vet.noFarmsMatch": "कोई फार्म आपके फ़िल्टर से मेल नहीं खाता।",
    "vet.last": "अंतिम",

      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold">{t("risk.assessment","Risk Assessment")}</h3>
          </div>
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span>{t("risk.currentScore","Current Score")}</span>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            <p className="text-muted-foreground">{t("risk.lastAssessment","Last Assessment")}</p>
            <p className="font-medium">{lastAssessment}</p>
          </div>
          <div>
            <p className="text-muted-foreground">{t("risk.nextDue","Next Due")}</p>
            <p className="font-medium">{daysUntilNext} {t("risk.days","days")}</p>
          </div>
        </div>
        
        <Button className="w-full" onClick={onStartNewAssessment}>
          {t("risk.startNew","Start New Assessment")}
        </Button>
      </CardContent>
    </Card>
  );
